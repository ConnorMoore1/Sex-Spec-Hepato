...
solo = {}
with open('GSE130991_Abundance_Male_Unique.tsv', 'r') as transcription:
...
Male_Liver = riptide.maxfit_contextualize(model=model, transcriptome=solo, conservative = True, samples = 110, frac_min = 0.3, frac_max = 0.4)

#riptide.save_output(Male_Liver)
Male_Liver_Samples = Male_Liver.flux_samples

sample_number_char = str(sample_number)
file_prefix = "/home/cjm4yy/Sex_Specific_Liver/RIPTiDe/Individual_Models/Samples_Low/Male_Liver_Samples_"
file_ending = ".xlsx"
